...
#Read in the file
df_all_data <- read.csv('STORM_Project_anonymised.csv')
...
final_df <- final_df %>% 
  mutate(Perception_Score_Total = Perception_1 + Perception_2 + Perception_3 + Perception_4 + Perception_5 + 
...
#Here this shows precisely how many elements the students have judged positively
final_df <- final_df %>% 
  mutate(Knowledge_Score_Total = Knowledge_1 + Knowledge_2 + Knowledge_3 + Knowledge_4 + Knowledge_5 + 
...
final_df <- final_df %>% 
  mutate(Awareness_Score_Total = Awareness_1 + Awareness_2 + Awareness_3 + Awareness_4 + Awareness_5 + 
...
final_df <- final_df %>% 
  mutate(Experience_Score_Total = Experience_1 + Experience_2 + Experience_3 + Experience_4 + Experience_5 + 
